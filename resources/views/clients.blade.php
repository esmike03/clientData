...
<body>
  <div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center content-center mb-6">
      ...
      <a href="/client-data"
        class="text-right bg-orange-500 p-2 rounded-md text-orange-100 cursor-pointer hover:scale-105 transition-transform">
        Pending Clients
      </a>
    </div>
  ...
  <script>
    ...
    // Delete function triggered by the delete button on each card
