        ...
        function showModal(data) {
          ...
          let html = `
            <div class="text-left space-y-2">
              <div class="grid grid-cols-2 gap-2 text-xs lg:text-lg">
              ...
              <p class="text-xs lg:text-lg">Discount/Deals:<strong> ${data.discount_deals}</strong></p>
              <p class="text-xs lg:text-lg">Tie-up Pharmacy/Doctors:<strong> ${data.tie_up_pharmacy}</strong></p>
              <p class="text-xs lg:text-lg">Rebates Given:<strong> ${data.rebates_given}</strong></p>
              <div class="grid grid-cols-2 gap-2 text-xs lg:text-lg">
          ...
          if (data.sketch_map) {
            html += `<p class="mt-2 text-xs lg:text-lg text-center"><strong>Sketch Map</strong><br><img src="${data.sketch_map}" alt="Sketch Map" class="w-full mb-4 border-1 rounded-md mx-auto"></p>`;
          }
          if (data.prepared_signature) {
            html += `<p class="text-right text-xs lg:text-lg mr-6">Prepared By:<br><strong> ${data.prepared_by}</strong></p>
